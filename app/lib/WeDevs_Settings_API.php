...
namespace BoxyBird\EmailReminder\Lib;
...
if (!class_exists('WeDevs_Settings_API')) {
    class WeDevs_Settings_API
    {
            ...
            foreach ($this->settings_fields as $section => $field) {
                foreach ($field as $option) {
                    ...
                    $args = [
                        ...
                        'sub_desc'          => isset($option['sub_desc']) ? $option['sub_desc'] : '',
                        'name'              => $name,
                        'section'           => $section,
                    ...
                    add_settings_field($section . '[' . $option['name'] . ']', $name, [$this, 'callback_' . $type], $section, $section, $args);
                }
            }
         ...
         * @param array   $args settings field args
         */
        public function get_field_sub_description($args)
        {
            if (!empty($args['sub_desc'])) {
                $sub_desc = sprintf('<p class="description">%s</p>', $args['sub_desc']);
            } else {
                $sub_desc = '';
            }
